...
Public Class frmWastage_cnt
    ...
    Function Save_Data()
        ...
        Try
            _REMARK = ""
            _REMARK = "Item Wastage -" & Trim(txtEntry.Text)
            Call Load_EntryNo()
            ...
            Else
                ...
                nvcFieldList1 = "Insert Into T01GRN_Header(T01Ref_No,T01Date,T01Time,T01Sup_Code,T01Loc_Code,T01Net_Amount,T01Dis_Rate,T01VAT,T01NBT,T01Remark,T01User,T01Status,T01Com_Invoice,T01PO,T01Tr_Type)" & _
                                                                " values('" & Trim(txtEntry.Text) & "','" & _GetDate & "', '" & _Get_Time & "','" & _Supplier & "','" & _Location & "','" & CDbl(txtNett.Text) & "','0','0','0','" & Trim(txtRemark.Text) & "','" & strDisname & "','A','-','-','WST')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                '===================================================================================
                'SAVE DATA ON T04PROFIT_LOSS
                nvcFieldList1 = "Insert Into T04Profit_Loss(T04Date,T04Tr_Type,T04Ref_No,T04Description,T04Cr,T04Dr,T04Status)" & _
                                                                    " values('" & _GetDate & "','WST','" & Trim(txtEntry.Text) & "', '" & _REMARK & "','0','" & CDbl(txtNett.Text) & "','A')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                '===================================================================================
                ...
                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                                  " values('WST','SAVE', '" & _Get_Time & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                i = 0
                For Each uRow As UltraGridRow In UltraGrid1.Rows
                    ...
                    nvcFieldList1 = "Insert Into S01Stock_Balance(S01Item_Code,S01Ref_No,S01Date,S01Time,S01Tr_Type,S01Qty,S01Status)" & _
                                                             " values('" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "' ,'" & Trim(txtEntry.Text) & "', '" & _GetDate & "','" & _Get_Time & "','WST','" & -(UltraGrid1.Rows(i).Cells(5).Text) & "','A')"
                    ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                    '========================================================================
                    'SAVE T02GRN_FLUTTER
                ...
                Next
                transaction.Commit()
                A = MsgBox("Are you sure you want to print Wastage Entry Note", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Print Dispatch Note .......")
                If A = vbYes Then
                    A = ConfigurationManager.AppSettings("ReportPath") + "\Wastage_Note.rpt"
                    B.Load(A.ToString)
                    ...
                    frmReport.CrystalReportViewer1.SelectionFormula = "{View_Wastage_Header.T01Ref_No}='" & Trim(txtEntry.Text) & "' "
                    frmReport.Refresh()
    ...
    Function Edit_Data()
        ...
        Try
            ...
            MB51 = DBEngin.ExecuteDataset(connection, transaction, nvcFieldList1)
            If isValidDataset(MB51) Then
                nvcFieldList1 = "UPDATE T01GRN_Header SET T01Date='" & _GetDate & "',T01Sup_Code='" & _Supplier & "',T01Net_Amount='" & CDbl(txtNett.Text) & "',T01Dis_Rate='0',T01VAT='0',T01NBT='0',T01Remark='" & Trim(txtRemark.Text) & "',T01Com_Invoice='-',T01PO='-',T01Status='A' WHERE T01Ref_No='" & txtEntry.Text & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE T04Profit_Loss SET T04Date='" & _GetDate & "',T04Dr='" & CDbl(txtNett.Text) & "',T04Status='A' WHERE T04Ref_No='" & txtEntry.Text & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)


                'SAVE DATA ON TMPTRANSACTION_LOG
                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                                  " values('WST','EDIT', '" & _Get_Time & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "DELETE FROM T02GRN_Flutter WHERE T02Ref_No='" & txtEntry.Text & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE S01Stock_Balance SET S01Status='CANCEL' WHERE S01Ref_No='" & txtEntry.Text & "' AND S01Tr_Type='WST'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Function Search_Records()
        ...
        Try
            Sql = "select *  from View_Wastage_Header where T01Ref_No='" & txtEntry.Text & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
            ...
            Sql = "select * from View_Wastage_Fluter where T01Ref_No='" & Trim(txtEntry.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            i = 0
            For Each DTRow2 As DataRow In M01.Tables(0).Rows

                Dim newRow As DataRow = c_dataCustomer1.NewRow
                newRow("#Ref.No") = Trim(M01.Tables(0).Rows(i)("M05Ref_No"))
                ...
                Sql = "select * from M12Store_Location where M12Item_Code='" & Trim(M01.Tables(0).Rows(i)("M05Ref_No")) & "'"
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                ...
                nvcFieldList1 = "UPDATE T04Profit_Loss SET T04Status='CLOSE' WHERE T04Ref_No='" & Trim(txtEntry.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE S01Stock_Balance SET S01Status='CLOSE' WHERE S01Ref_No='" & Trim(txtEntry.Text) & "' AND S01Tr_Type='WST'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                              " values('WST','DELETE', '" & _Get_Time & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub txtCell_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCell.KeyUp
        ...
        Try
            If e.KeyCode = 13 Then
                Sql = "select * from M05Item_Master WHERE M05Status='A' and M05Ref_No='" & _Itemcode & "'"
                M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(M01) Then
                Else
                ...
                'Sql = "select * from M05Item_Master where M05Ref_No='" & _Itemcode & "' and M05Status='A' "
    ...
    Private Sub DeactivateToolStripMenuItem_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeactivateToolStripMenuItem.Click
        frmView_Wastage.Close()
