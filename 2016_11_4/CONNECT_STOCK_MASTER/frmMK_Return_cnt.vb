...
Public Class frmMK_Return_cnt
    ...
    Private Sub frmMK_Return_cnt_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frmView_Items_cnt.Close()
        frmView_Supplier_Retun.Close()
    End Sub

    Private Sub frmMK_Return_cnt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Function Search_Supplier() As Boolean
        ...
        Try
            Sql = "select M04Code from M04Supplier where  M04Status='A'  and M04Name='" & Trim(cboTo.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
    ...
    Function Search_Location() As Boolean
        ...
        Try
            Sql = "select M11ID from M11Common WHERE M11Status='LC' and M11Name='" & Trim(cboLocation.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
    ...
    Private Sub txtCell_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCell.KeyUp
        ...
        Try
            If e.KeyCode = 13 Then
                ...
                'Sql = "select * from M05Item_Master where M05Item_Code='" & _Itemcode & "' and M05Status='A' "
        ...
        Try
            ...
            If isValidDataset(M01) Then
                If M01.Tables(0).Rows(0)("P01No") >= 1 And M01.Tables(0).Rows(0)("P01No") < 10 Then
                    txtEntry.Text = "SR-00" & M01.Tables(0).Rows(0)("P01No")
                ElseIf M01.Tables(0).Rows(0)("P01No") >= 10 And M01.Tables(0).Rows(0)("P01No") < 100 Then
                    txtEntry.Text = "SR-0" & M01.Tables(0).Rows(0)("P01No")
                Else
                    txtEntry.Text = "SR-" & M01.Tables(0).Rows(0)("P01No")
                End If
            End If
    ...
    Function Save_Data()
        ...
        Try
            ...
            Else
                ...
                nvcFieldList1 = "update P01Parameter set P01No=P01No+ " & 1 & " where P01Code='MK' "
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                'SAVE DATA ON T04Supplier_Return_Header
                nvcFieldList1 = "Insert Into T01GRN_Header(T01Ref_No,T01Date,T01Time,T01Sup_Code,T01Loc_Code,T01Net_Amount,T01Dis_Rate,T01VAT,T01NBT,T01Remark,T01User,T01Status,T01Com_Invoice,T01PO,T01Tr_Type)" & _
                                                                " values('" & Trim(txtEntry.Text) & "','" & _GetDate & "', '" & _Get_Time & "','" & _Supplier & "','" & _Location & "','" & CDbl(txtNett.Text) & "','0','0','0','" & Trim(txtRemark.Text) & "','" & strDisname & "','A','" & Trim(UCase(txtCom_Invoice.Text)) & "','" & txtPO.Text & "','SP_RETURN')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                '===================================================================================
                ...
                nvcFieldList1 = "Insert Into T03Supplier_Tr_Account(T03Pay_No,T03Tr_Type,T03Date,T03Time,T03Sup_Code,T03Ref_No,T03Cash,T03Chq,T03Credit,T03Status)" & _
                                                                    " values('-','SP_RETURN','" & _GetDate & "', '" & _Get_Time & "','" & _Supplier & "','" & Trim(txtEntry.Text) & "','0','0','" & -(txtNett.Text) & "','A')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                '===================================================================================
                ...
                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                                  " values('SP_RETURN','SAVE', '" & _Get_Time & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                i = 0
                For Each uRow As UltraGridRow In UltraGrid1.Rows
                    ...
                    nvcFieldList1 = "Insert Into S01Stock_Balance(S01Item_Code,S01Ref_No,S01Date,S01Time,S01Tr_Type,S01Qty,S01Status)" & _
                                                             " values('" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "' ,'" & Trim(txtEntry.Text) & "', '" & _GetDate & "','" & _Get_Time & "','SP_RETURN','" & -(UltraGrid1.Rows(i).Cells(5).Text) & "','A')"
                    ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                    '========================================================================
                    'SAVE T02GRN_FLUTTER
                ...
                connection.ClearAllPools()
                connection.Close()
                A = MsgBox("Are you sure you want to print Supplier Return Note", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Print Dispatch Note .......")
                If A = vbYes Then
                    A = ConfigurationManager.AppSettings("ReportPath") + "\Supplier_Return.rpt"
                    B.Load(A.ToString)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                ...
                nvcFieldList1 = "UPDATE S01Stock_Balance SET S01Status='CLOSE' WHERE S01Ref_No='" & Trim(txtEntry.Text) & "' AND S01Tr_Type='SP_RETURN'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                              " values('SP_RETURN','DELETE', '" & _Get_Time & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Function Edit_Data()
        ...
        Try
            ...
            MB51 = DBEngin.ExecuteDataset(connection, transaction, nvcFieldList1)
            If isValidDataset(MB51) Then
                nvcFieldList1 = "UPDATE T01GRN_Header SET T01Date='" & _GetDate & "',T01Sup_Code='" & _Supplier & "',T01Net_Amount='" & CDbl(txtNett.Text) & "',T01Dis_Rate='0',T01VAT='0',T01NBT='0',T01Remark='" & Trim(txtRemark.Text) & "',T01Com_Invoice='" & Trim(txtCom_Invoice.Text) & "',T01PO='" & txtPO.Text & "',T01Status='A' WHERE T01Ref_No='" & txtEntry.Text & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE T03Supplier_Tr_Account SET T03Date='" & _GetDate & "',T03Sup_Code='" & _Supplier & "',T03Credit='" & CDbl(txtNett.Text) & "',T03Status='A' WHERE T03Ref_No='" & txtEntry.Text & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)


                'SAVE DATA ON TMPTRANSACTION_LOG
                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmpStatus,tmpProcess,tmpTime,tmpUser,tmpCode)" & _
                                                                  " values('SP_RETURN','EDIT', '" & _Get_Time & "','" & strDisname & "','" & Trim(txtEntry.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "DELETE FROM T02GRN_Flutter WHERE T02Ref_No='" & txtEntry.Text & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE S01Stock_Balance SET S01Status='CANCEL' WHERE S01Ref_No='" & txtEntry.Text & "' AND S01Tr_Type='SP_RETURN'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                For Each uRow As UltraGridRow In UltraGrid1.Rows
                    'SAVE S01STOCK_BALANCE
                    nvcFieldList1 = "Insert Into S01Stock_Balance(S01Item_Code,S01Ref_No,S01Date,S01Time,S01Tr_Type,S01Qty,S01Status)" & _
                                                             " values('" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "' ,'" & Trim(txtEntry.Text) & "', '" & _GetDate & "','" & _Get_Time & "','SP_RETURN','" & -(UltraGrid1.Rows(i).Cells(4).Text) & "','A')"
                    ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                    '========================================================================
                    'SAVE T02GRN_FLUTTER
                    nvcFieldList1 = "Insert Into T02GRN_Flutter(T02Ref_No,T02Part_No,T02Cost,T02Retail,T02Qty,T02Status)" & _
                                                           " values('" & Trim(txtEntry.Text) & "' ,'" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "', '" & Trim(UltraGrid1.Rows(i).Cells(2).Text) & "','" & Trim(UltraGrid1.Rows(i).Cells(3).Text) & "','" & Trim(UltraGrid1.Rows(i).Cells(4).Text) & "','A')"
                    ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                    '========================================================================
                    'RACK NO
                    ...
                    MB51 = DBEngin.ExecuteDataset(connection, transaction, nvcFieldList1)
                    If isValidDataset(MB51) Then
                        nvcFieldList1 = "update M12Store_Location set M12Rack='" & Trim(UltraGrid1.Rows(i).Cells(5).Text) & "',M12Cell='" & Trim(UltraGrid1.Rows(i).Cells(6).Text) & "' where M12Item_Code='" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "' "
                        ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                    Else
                        nvcFieldList1 = "Insert Into M12Store_Location(M12Item_Code,M12Rack,M12Cell)" & _
                                                                          " values('" & Trim(UltraGrid1.Rows(i).Cells(0).Text) & "','" & Trim(UltraGrid1.Rows(i).Cells(5).Text) & "', '" & Trim(UltraGrid1.Rows(i).Cells(6).Text) & "')"
                        ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                    End If
                    i = i + 1
                Next
    ...
    Function Search_Records()
        ...
        Try
            ...
            If isValidDataset(M01) Then
                ...
                cboTo.Text = M01.Tables(0).Rows(0)("M04Name")
                cboLocation.Text = M01.Tables(0).Rows(0)("M11Name")
            ...
            For Each DTRow2 As DataRow In M01.Tables(0).Rows
                ...
                newRow("#Part No") = Trim(M01.Tables(0).Rows(i)("T02Part_No"))
