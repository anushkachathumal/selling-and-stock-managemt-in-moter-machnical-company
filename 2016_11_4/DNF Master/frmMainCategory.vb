...
Public Class frmMainCategory
    ...
    Private Sub txtDescription_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDescription.TextChanged
        ...
        If txtDescription.Text <> "" Then
            Try
                Sql = "select * from M01Dyeing_MC_Type where M01Code='" & Trim(txtCode.Text) & "'"
    ...
    Function SearchRecords() As Boolean
        ...
        SearchRecords = False
        Try
            Sql = "select M01Description from M01Dyeing_MC_Type where M01Code='" & Trim(txtCode.Text) & "'"
            dsUser = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If dsUser.Tables(0).Rows.Count > 0 Then
                SearchRecords = True
    ...
    Function LoadGride()
        ...
        Try
            Sql = "select M01Code as [Code],M01Description as [Description] from M01Dyeing_MC_Type "
            dsUser = DBEngin.ExecuteDataset(con, Nothing, Sql)
    ...
    Private Sub frmMainCategory_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call LoadGride()
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            If Trim(txtCode.Text) <> "" And Trim(txtDescription.Text) <> "" Then
                nvcFieldList1 = "Insert Into M01Dyeing_MC_Type(M01Code,M01Description)" & _
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                nvcFieldList = "delete from M01Dyeing_MC_Type where  M01Code = '" & Trim(txtCode.Text) & "'"
