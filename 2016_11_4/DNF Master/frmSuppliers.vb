...
Public Class frmSuppliers
    ...
    Function FindRecords() As Boolean
        ...
        FindRecords = False
        Try
            Sql = "select * from M02Group where M02Code='" & Trim(txtCode.Text) & "'"
            dsUser = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(dsUser) Then
                FindRecords = True
                txtName.Text = dsUser.Tables(0).Rows(0)("M02Name")
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If Trim(txtCode.Text) <> "" And Trim(txtName.Text) <> "" Then
                nvcFieldList1 = "Insert Into M02Group(M02Code,M02Name)" & _
        ...
        Try
            ...
            If A = vbYes Then
                ...
                If FindRecords() = True Then
                    nvcFieldList = "delete from M02Group where  M02Code = '" & Trim(txtCode.Text) & "'"
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            If Trim(txtCode.Text) <> "" And Trim(txtName.Text) <> "" Then
                nvcFieldList1 = "Update M02Group set M02Name='" & Trim(txtName.Text) & "' where M02Code='" & Trim(txtCode.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            Else
                MsgBox("Please enter the complete records", MsgBoxStyle.Information, "Textured Jersey ........")
            End If
    ...
    Function LoadGride()
        ...
        Try
            Sql = "select M02Code as [Group Code],M02Name as [Description] from M02Group"
            dsUser = DBEngin.ExecuteDataset(con, Nothing, Sql)
