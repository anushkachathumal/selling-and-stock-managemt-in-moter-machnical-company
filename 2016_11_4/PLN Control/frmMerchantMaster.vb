...
Public Class frmMerchantMaster
    ...
    Function Load_Unit()
        ...
        Try
            Sql = "select M14Name as [Unit] from M14Retailer "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                cboUnit.DataSource = M01
                cboUnit.Rows.Band.Columns(0).Width = 125
    ...
    Private Sub frmMerchantMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Load_Unit()
        Call LoadGride()
    End Sub
    ...
    Function LoadGride()
        ...
        Try
            Sql = "select M14Name as [Unit],M13Merchant as [Merchant] from M13Biz_Unit inner join M14Retailer on M13Department=M14Code"
    ...
    Function Search_Unit() As Boolean
        ...
        Try
            Sql = "SELECT * from M14Retailer WHERE M14Name='" & Trim(cboUnit.Text) & "' "
    ...
    Private Sub UltraButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UltraButton1.Click
        ...
        Try
            ...
            Else
                MsgBox("Please select the Unit", MsgBoxStyle.Information, "Information ........")
            End If

            nvcFieldList1 = "select * from M13Biz_Unit where M13Merchant='" & Trim(cboMerchant.Text) & "'"
            dsUser = DBEngin.ExecuteDataset(connection, transaction, nvcFieldList1)
            If isValidDataset(dsUser) Then
                nvcFieldList1 = "Update M13Biz_Unit  set M13Department=" & _UnitCode & " where M13Merchant='" & Trim(cboMerchant.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            Else
                nvcFieldList1 = "Insert Into M13Biz_Unit(M13Department,M13Merchant)" & _
                                                              " values('" & _UnitCode & "', '" & Trim(cboMerchant.Text) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            End If
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If A = vbYes Then
                nvcFieldList1 = "delete from M13Biz_Unit  where M13Merchant='" & Trim(cboMerchant.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            End If
