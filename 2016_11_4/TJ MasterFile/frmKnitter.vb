...
Public Class frmKnitter
    ...
    Function LoadGride()
        ...
        Sql = "select M08Code as [EPF No],M08Name as [Name] from M08Kitters_Details"
    ...
    Function LoadGride1()
        ...
        Sql = "select M08Code as [EPF No],M08Name as [Name] from M08Kitters_Details where  M08Name like '" & Trim(txtVoucher.Text) & "%'"
        M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
        UltraGrid1.DataSource = M01
        With UltraGrid1
            .DisplayLayout.Bands(0).Columns(0).Width = 170
    ...
    Function Serch_Records()
        ...
        Try
            Sql = "select * from M08Kitters_Details where M08Code='" & Trim(txtDis.Text) & "' "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                txtVoucher.Text = M01.Tables(0).Rows(0)("M08Name")
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            If Trim(txtVoucher.Text) <> "" Then
                ...
                nvcFieldList1 = "Insert Into M08Kitters_Details(M08Code,M08Name)" & _
                ...
                'End If
            Else
                MsgBox("Knitter Name cannot be blank...! ", MsgBoxStyle.Information, "Information ....")
                txtVoucher.Focus()
            End If
    ...
    Private Sub frmKnitter_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call LoadGride()
    End Sub
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            If Trim(txtVoucher.Text) <> "" Then
                ...
                nvcFieldList1 = "update M08Kitters_Details set M08Name='" & Trim(txtVoucher.Text) & "' where M08code='" & Trim(txtDis.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                nvcFieldList1 = "delete from M08Kitters_Details  where M08Code='" & Trim(txtDis.Text) & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
