...
Public Class frmDCA_CONSUMPTION
    ...
    Function Upload_File()
        ...
        Try
            strFileName = ConfigurationManager.AppSettings("FilePath") + "\DCA_CONSUMPTION.txt"
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            strFileName = ConfigurationManager.AppSettings("FilePath") + "\ZDCA_PURCHASE.txt"
            For Each line As String In System.IO.File.ReadAllLines(strFileName)
                Dim fields() As String = line.Split(vbTab)
                MTNo = Trim(fields(0))
                _Plant = Trim(fields(1))
                _StockLoc = Trim(fields(2))
                nvcFieldList1 = "select * from ZDCA_PURCHASE where Material='" & CInt(Trim(fields(0))) & "' and Material_Doc_No='" & Trim(fields(4)) & "' and Status='C'"
                ...
                Else
                    ...
                    nvcFieldList1 = "Insert Into ZDCA_PURCHASE(Material,Plant,Stock_Loc,Movement_Type,Material_Doc_No,Posting_Date,Qty,Unit,Batch_No,PO_No,Day_WithAcc,Status)" & _
                                                             " values('" & CInt(Trim(fields(0))) & "', " & Trim(fields(1)) & "," & Trim(fields(2)) & ",'" & Trim(fields(3)) & "','" & Trim(fields(4)) & "','" & p_Date & "'," & Trim(fields(6)) & ",'" & Trim(fields(7)) & "','" & Trim(fields(8)) & "','" & Trim(fields(9)) & "','" & t_Date & "','C')"
    ...
    Private Sub frmDCA_CONSUMPTION_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Load_Gride()
    End Sub
