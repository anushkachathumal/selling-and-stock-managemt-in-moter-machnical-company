...
Public Class frmGood_Transfer
    ...
    Function Search_From() As Boolean
        ...
        Try
            ...
            If isValidDataset(dsUser) Then
                _SupCode = dsUser.Tables(0).Rows(0)("M04Loc_Code")
                Search_From = True
            Else
                Search_From = False
            End If
    ...
    Function Load_EntryNo()
        ...
        Try
            Sql = "select * from P01Parameter where  P01Code='TR'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                If M01.Tables(0).Rows(0)("P01LastNo") >= 1 And M01.Tables(0).Rows(0)("P01LastNo") < 10 Then
                    txtEntry.Text = "TR-00" & M01.Tables(0).Rows(0)("P01LastNo")
                ElseIf M01.Tables(0).Rows(0)("P01LastNo") >= 10 And M01.Tables(0).Rows(0)("P01LastNo") < 100 Then
                    txtEntry.Text = "TR-0" & M01.Tables(0).Rows(0)("P01LastNo")
                Else
                    txtEntry.Text = "TR-" & M01.Tables(0).Rows(0)("P01LastNo")
                End If
            End If
    ...
    Function Load_Combo()
        ...
        Try
            Sql = "select M04Loc_Name as [From Location] from M04Location where M04Com_Code='" & _Comcode & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            With cboLocation
                .DataSource = M01
    ...
    Function Load_Location()
        ...
        Try
            Sql = "select M04Loc_Name as [##] from M04Location where M04Loc_Name<>'" & cboLocation.Text & "' and M04Com_Code='" & _Comcode & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            With cboTo
                .DataSource = M01
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        Try
            ...
            nvcFieldList1 = "update P01Parameter set P01LastNo=P01LastNo+ " & 1 & " where P01Code='TR' "
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            ...
            For Each uRow As UltraGridRow In UltraGrid1.Rows
                ...
                nvcFieldList1 = "Insert Into S01Stock_Balance(S01Loc_Code,S01Item_Code,S01Date,S01Trans_Type,S01Qty,S01Ref_No,S01Com_Code,S01STATUS)" & _
                                                              " values('" & _SupCode & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & txtDate.Text & "','TR','" & -(UltraGrid1.Rows(i).Cells(4).Value) & "','" & _RefNo & "','" & _Comcode & "','A')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                nvcFieldList1 = "Insert Into S04Stock_Price(S04Location,S04Tr_Type,S04Date,S04Item_Code,S04Qty,S04Ref_No,S04Status,S04Rate,S04Com_Code)" & _
                                                               " values('" & _SupCode & "','TR','" & txtDate.Text & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & -(UltraGrid1.Rows(i).Cells(4).Text) & "','" & _RefNo & "','A','" & (UltraGrid1.Rows(i).Cells(3).Value) & "','" & _Comcode & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                If isValidDataset(M01) Then
                    nvcFieldList1 = "Insert Into S03Ex_Stock(S03Loc_Code,S03Tr_Type,S03Item_Code,S03Qty,S03Ex_Date,S03Status,S03Ref_No,S03Com_Code)" & _
                                                                " values('" & _SupCode & "','TR', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & -(UltraGrid1.Rows(i).Cells(4).Text) & "','" & UltraGrid1.Rows(i).Cells(6).Text & "','A','" & _RefNo & "','" & _Comcode & "')"
                    ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            ...
            nvcFieldList1 = "Insert Into T01Transaction_Header(T01Trans_Type,T01Ref_No,T01Date,T01Invoice_No,T01FromLoc_Code,T01To_Loc_Code,T01Net_Amount,T01Com_Discount,T01DisRate,T01Vat,T01FreeIssue,T01Market_Return,T01Profit,T01Com_Code,T01Discount,T01User,T01Remark,T01PO_NO,T01Grn_No,T01Status)" & _
                                                              " values('TR', '" & _RefNo & "','" & txtDate.Text & "','" & txtCom_Invoice.Text & "','" & _SupCode & "','" & _Loccode & "','" & CDbl(txtNett.Text) & "','" & txtDiscount.Text & "','" & txtDis_Rate.Text & "','" & txtVAT.Text & "','0','" & txtMarket.Text & "','0','" & _Comcode & "','0','" & strDisname & "','" & txtRemark.Text & "','" & txtPO.Text & "','" & txtEntry.Text & "','A')"
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            ...
            transaction.Commit()
            A = MsgBox("Are you sure you want to print Transfer Note", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Print Dispatch Note .....")
            If A = vbYes Then
                A1 = ConfigurationManager.AppSettings("ReportPath") + "\Transper_Note.rpt"
                B.Load(A1.ToString)
                ...
                frmReport.CrystalReportViewer1.SelectionFormula = "{View_Transfer.T01Ref_No} =" & _RefNo & " and {View_Transfer.M04Loc_Code}='" & _Comcode & "' "
                frmReport.Refresh()
    ...
    Function Search_RecordsUsing_Entry()
        ...
        Try
            Sql = "select * from T01Transaction_Header inner join T02Transaction_Flutter  on T01Ref_No=T02Ref_No  inner join M03Item_Master on T02Item_Code=M03Item_Code  inner join M04Location on M04Loc_Code=T01To_Loc_Code  where T01Grn_No='" & Trim(txtEntry.Text) & "' and T01Trans_Type='TR' and T01Com_Code='" & _Comcode & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                Sql = "select * from M04Location where M04Loc_Code='" & Trim(M01.Tables(0).Rows(0)("T01FromLoc_Code")) & "' and M04Com_Code='" & _Comcode & "'"
                M02 = DBEngin.ExecuteDataset(con, Nothing, Sql)
                If isValidDataset(M02) Then
                    cboLocation.Text = Trim(M02.Tables(0).Rows(0)("M04Loc_Name"))
                End If
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            nvcFieldList1 = "delete from S01Stock_Balance where S01Ref_No='" & _RefNo & "'  and S01Trans_Type='TR'"
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)

            nvcFieldList1 = "delete from S03Ex_Stock where S03Ref_No='" & _RefNo & "'  and S03Tr_Type='TR'"
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)

            nvcFieldList1 = "delete from S04Stock_Price where S04Ref_No='" & _RefNo & "'  and S04Tr_Type='TR'"
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If strDelete = Windows.Forms.DialogResult.Yes Then
                nvcFieldList1 = "update T01Transaction_Header set T01status='I' where T01Ref_No='" & _RefNo & "'and T01Trans_Type='TR'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                nvcFieldList1 = "UPDATE S01Stock_Balance SET S01STATUS='I' where  S01Ref_No='" & _RefNo & "' and S01Trans_Type='TR'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE S03Ex_Stock SET S03STATUS='I' where  S03Ref_No='" & _RefNo & "' and S03Tr_Type='TR'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "UPDATE S04Stock_Price SET S04STATUS='I' where  S04Ref_No='" & _RefNo & "' and S04Tr_Type='TR' AND S04Location='" & _Loccode & "'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into tmpTransaction_Log(tmp_TR,tmpProcess,tmpRef_No,tmpTime,tmpAthz,tmpUser,tmpLog)" & _
                                                          " values('TR', 'DELETE','" & txtEntry.Text & "','" & Now & "','" & _AthzUser & "','" & strDisname & "','" & _Comcode & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub UltraButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UltraButton1.Click
        ...
        Try
            A = ConfigurationManager.AppSettings("ReportPath") + "\Transper_Note.rpt"
            B.Load(A.ToString)
            B.SetDatabaseLogon("sa", "tommya")
    ...
    Function Load_Data()
        ...
        Try
            Sql = "select T01Grn_No as [Transfer No],M04Loc_Name as [To Location],T01Invoice_No as [Invoice No],CONVERT(varchar,CAST(T01Net_Amount AS money), 1) as [Net Amount] from T01Transaction_Header inner join M04Location on M04Loc_Code=T01FromLoc_Code where t01trans_type='TR' and t01date='" & Today & "' AND T01STATUS='A' and T01Com_Code='" & _Comcode & "' "
            dsUser = DBEngin.ExecuteDataset(con, Nothing, Sql)
    ...
    Private Sub frmGood_Transfer_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frmViewTransfer.Close()
    End Sub

    Private Sub frmGood_Transfer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
