...
Public Class frmMarket_Return
    ...
    Function Search_Supplier() As Boolean
        ...
        Try
            Sql = "select * from M09Supplier where M09Name='" & Trim(cboTo.Text) & "' and M09Active='A' "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                Search_Supplier = True
                _Loccode = M01.Tables(0).Rows(0)("M09Code")
            End If
    ...
    Private Sub frmMarket_Return_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Function Load_EntryNo()
        ...
        Try
            ...
            Sql = "select * from M01Account_Master where  M01Acc_Type='SP' "
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                cboTo.Text = M01.Tables(0).Rows(0)("M01Acc_Name")
            End If
    ...
    Function Load_ToLocation()
        ...
        Try
            Sql = "select M01Acc_Name as [From Location] from M01Account_Master where  M01Acc_Type='SP'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            With cboTo
                .DataSource = M01
                .Rows.Band.Columns(0).Width = 270
    ...
    Function Search_ItemCode()
        ...
        Try
            Sql = "select * from M03Item_Master where  M03Item_Name='" & Trim(cboItemName.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
    ...
    Function Search_ItemName() As Boolean
        ...
        Dim Value As Double
        Try
            Sql = "select * from M03Item_Master where  M03Item_Code='" & Trim(cboCode.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        Try
            ...
            Else
                MsgBox("Please enter the correct Supplier", MsgBoxStyle.Information, "Information .......")
                connection.Close()
                Exit Sub
            End If
            ...
            For Each uRow As UltraGridRow In UltraGrid1.Rows
                ...
                nvcFieldList1 = "Insert Into T02Transaction_Flutter(T02Ref_No,T02Item_Code,T02Cost,T02Retail_Price,T02Commition,T02Com_Discount,T02Qty,T02Rec_Qty,T02Free_Issue,T02Status,T02Item_Received,T02Com_Code,T02Total)" & _
                                                              " values('" & txtEntry.Text & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & (UltraGrid1.Rows(i).Cells(2).Value) & "','0','0','0','" & (UltraGrid1.Rows(i).Cells(3).Value) & "','0','0','A','" & _Status & "','" & _Comcode & "','" & (UltraGrid1.Rows(i).Cells(5).Value) & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                nvcFieldList1 = "Insert Into S01Stock_Balance(S01Loc_Code,S01Item_Code,S01Date,S01Trans_Type,S01Qty,S01Free_Issue,S01Ref_No,S01Com_Code)" & _
                                                              " values('" & _FromLocCode & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & txtDate.Text & "','MR','" & -Val(UltraGrid1.Rows(i).Cells(3).Value) & "','0','" & txtEntry.Text & "','" & _Comcode & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)


                nvcFieldList1 = "Insert Into S01Stock_Balance(S01Loc_Code,S01Item_Code,S01Date,S01Trans_Type,S01Qty,S01Free_Issue,S01Ref_No,S01Com_Code)" & _
                                                              " values('" & _Comcode & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & txtDate.Text & "','MRS','" & Val(UltraGrid1.Rows(i).Cells(3).Value) & "','0','" & txtEntry.Text & "','" & _Comcode & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            ...
            nvcFieldList1 = "Insert Into T01Transaction_Header(T01Trans_Type,T01Ref_No,T01Date,T01Invoice_No,T01FromLoc_Code,T01To_Loc_Code,T01Net_Amount,T01Com_Discount,T01DisRate,T01Vat,T01FreeIssue,T01Market_Return,T01Profit,T01Com_Code,T01Discount,T01User)" & _
                                                              " values('MR', '" & txtEntry.Text & "','" & txtDate.Text & "','" & txtCom_Invoice.Text & "','" & _FromLocCode & "','" & _Loccode & "','" & txtNett.Text & "','" & txtDiscount.Text & "','" & txtDis_Rate.Text & "','" & txtVAT.Text & "','" & txtFree_Amount.Text & "','" & txtMarket.Text & "','0','" & _Comcode & "','0','" & strDisname & "')"
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Function Search_RecordsUsing_Entry()
        ...
        Try
            Sql = "select * from T01Transaction_Header inner join T02Transaction_Flutter  on T01Ref_No=T02Ref_No  inner join M03Item_Master on T02Item_Code=M03Item_Code  inner join M04Location on M04Loc_Code=T01FromLoc_Code  where  T01Ref_No='" & Trim(txtSearch.Text) & "' and T01Trans_Type='MR'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If strDelete = Windows.Forms.DialogResult.Yes Then
                nvcFieldList1 = "delete from T01Transaction_Header where T01Ref_No='" & txtEntry.Text & "'  and T01Trans_Type='MR'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
                ...
                nvcFieldList1 = "delete from S01Stock_Balance where S01Loc_Code='" & _FromLocCode & "'  and S01Ref_No='" & txtEntry.Text & "' and S01Trans_Type='MR'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "delete from S01Stock_Balance where S01Loc_Code='" & _Comcode & "'  and S01Ref_No='" & txtEntry.Text & "' and S01Trans_Type='MRS'"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            nvcFieldList1 = "delete from S01Stock_Balance where S01Ref_No='" & txtEntry.Text & "'  and S01Trans_Type='MR'"
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            ...
            For Each uRow As UltraGridRow In UltraGrid1.Rows
                ...
                nvcFieldList1 = "Insert Into S01Stock_Balance(S01Loc_Code,S01Item_Code,S01Date,S01Trans_Type,S01Qty,S01Free_Issue,S01Ref_No,S01Com_Code)" & _
                                                              " values('" & _FromLocCode & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & txtDate.Text & "','MR','" & -Val(UltraGrid1.Rows(i).Cells(3).Value) & "','" & Val(UltraGrid1.Rows(i).Cells(4).Value) & "','" & txtEntry.Text & "','" & _Comcode & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                nvcFieldList1 = "Insert Into S01Stock_Balance(S01Loc_Code,S01Item_Code,S01Date,S01Trans_Type,S01Qty,S01Free_Issue,S01Ref_No,S01Com_Code)" & _
                                                             " values('" & _Comcode & "', '" & (UltraGrid1.Rows(i).Cells(0).Value) & "','" & txtDate.Text & "','MRS','" & Val(UltraGrid1.Rows(i).Cells(3).Value) & "','" & Val(UltraGrid1.Rows(i).Cells(4).Value) & "','" & txtEntry.Text & "','" & _Comcode & "')"
                ExecuteNonQueryText(connection, transaction, nvcFieldList1)

                i = i + 1
            Next

            nvcFieldList1 = "update T01Transaction_Header set T01Net_Amount='" & txtNett.Text & "',T01Com_Discount='" & txtDiscount.Text & "',T01DisRate='" & txtDis_Rate.Text & "',T01Vat='" & txtVAT.Text & "',T01FreeIssue='" & txtFree_Amount.Text & "',T01Market_Return='" & txtMarket.Text & "',T01FromLoc_Code='" & _FromLocCode & "' where T01Ref_No='" & txtEntry.Text & "' and T01Trans_Type='MR' "
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
            '-------------------------------------------------------------------
