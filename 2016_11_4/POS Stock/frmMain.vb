...
Public Class frmMain
    ...
    Function Load_Gride()
        ...
        Try
            Sql = "select M02Cat_Code as [Category Code],M02Cat_Name as [Location Name] from M02Category WHERE M02Com_Code='" & _Comcode & "'"
    ...
    Function Search_Records()
        ...
        Try
            Sql = "select * from M02Category where M02Cat_Code='" & Trim(txtCode.Text) & "' AND M02Com_Code='" & _Comcode & "' "
            dsUser = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(dsUser) Then
                txtDescription.Text = dsUser.Tables(0).Rows(0)("M02Cat_Name")
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        Try
            ...
            End If
            '--------------------------------------------------------------------
            nvcFieldList1 = "Insert Into M02Category(M02Cat_Code,M02Cat_Name,M02Com_Code)" & _
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            End If
            '--------------------------------------------------------------------
            nvcFieldList1 = "update M02Category set M02Cat_Name='" & (Trim(txtDescription.Text)) & "' where M02Cat_Code='" & Trim(txtCode.Text) & "' AND M02Com_Code='" & _Comcode & "' "
            ExecuteNonQueryText(connection, transaction, nvcFieldList1)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            If A = vbYes Then
                nvcFieldList = "delete from M02Category where M02Cat_Code = '" & Trim(txtCode.Text) & "' AND M02Com_Code='" & _Comcode & "' "
