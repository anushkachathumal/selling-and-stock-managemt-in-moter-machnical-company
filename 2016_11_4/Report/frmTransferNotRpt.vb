...
Public Class frmTransferNotRpt
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            'A = ConfigurationManager.AppSettings("ReportPath") + "\Creditcollection.rpt"
            ...
            ''frmReport.CrystalReportViewer1.SelectionFormula = "{T01MotocycleSales.T01Date} in " & CDate(txtDate.Text) & " to " & CDate(txtTo.Text) & ""
            '' frmReport.CrystalReportViewer1.SelectionFormula = "{T11TransferNote.T11Date} in DateTime " & StrFromDate & " to DateTime " & StrToDate & ""

            'frmReport.CrystalReportViewer1.SelectionFormula = "{T07EasyPamentSummery.T07NextPaidDate} < DateTime  " & StrToDate & "and {T07EasyPamentSummery.T07Balance} > $0.00"
