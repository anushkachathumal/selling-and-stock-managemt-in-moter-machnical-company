...
Public Class frmPayMain_uniq
    ...
    Private Sub frmPayMain_uniq_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        ElseIf Trim(cboTearms.Text).Trim = "CREDIT" Then
            If CDbl(txtBalance.Text) <> CDbl(txtBill_Amount.Text) Then
        ...
        ElseIf Trim(cboTearms.Text).Trim = "CREDIT CARD" Then
            ...
            End If
        End If
        frmItem_Issue_Uniq.Save_Invoice()
        Me.Close()
    End Sub
End Class