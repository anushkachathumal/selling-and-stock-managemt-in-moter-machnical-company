...
Public Class AuditReport
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            A = ConfigurationManager.AppSettings("ReportPath") + "\AuditReport.rpt"
            B.Load(A.ToString)
            ...
            frmReport.CrystalReportViewer1.SelectionFormula = "{T01Transaction_Header.T01Date} in DateTime " & StrFromDate & " to DateTime " & StrToDate & " and {T01Transaction_Header.T01Audit} <> ''"
            frmReport.Refresh()
