...
Public Class frmMachine_Downtime
    ...
    Function Search_ID()
        ...
        Try
            Sql = "select * from C01Workstation where C01Description='" & Trim(cboEmp.Text) & "'"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            If isValidDataset(M01) Then
                _WID = M01.Tables(0).Rows(0)("C01ID")
            End If
    ...
    Private Sub frmMachine_Downtime_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'load NSL Combo box
        Dim Sql As String
        Dim con = New SqlConnection()
        con = DBEngin.GetConnection(True)
        ...
        Try
            Sql = "select C01Description as [Machine Name] from C01Workstation order by C01Description"
            M01 = DBEngin.ExecuteDataset(con, Nothing, Sql)
            With cboEmp
                .DataSource = M01
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        Try
            ...
            If chk1.Checked = True Then
                ...
                A = ConfigurationManager.AppSettings("ReportPath") + "\Machine_Down.rpt"
                B.Load(A.ToString)
                ...
                frmReport.CrystalReportViewer1.SelectionFormula = "{T18Downtime.T18Timein} in DateTime " & StrFromDate & " to DateTime " & StrToDate & " and {T18Downtime.T18Time} >0 and {T18Downtime.T18Workstation}='" & _WID & "' and {T18Downtime.T18OrderNo}<>''"
                frmReport.Refresh()
            ...
            Else
                ...
                frmReport.CrystalReportViewer1.ReportSource = B 'intanance System\CrystalReport1" 'B ' "f:\salesinvo1.rpt" 'A.ToString '"F:\Stock Maintanance System\Report\salesinvo1.rpt"
                frmReport.CrystalReportViewer1.DisplayToolbar = True
                frmReport.CrystalReportViewer1.SelectionFormula = "{T18Downtime.T18Timein} in DateTime " & StrFromDate & " to DateTime " & StrToDate & " and {T18Downtime.T18OrderNo} <> '' and {T18Downtime.T18Workstation}='" & _WID & "'"
                frmReport.Refresh()
                ' frmReport.CrystalReportViewer1.PrintReport()
                ' B.PrintToPrinter(1, True, 0, 0)
                frmReport.MdiParent = MDIMain
